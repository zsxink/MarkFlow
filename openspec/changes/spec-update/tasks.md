...
- [x] 1.1 删除空目录：src-tauri/src/markdown/、src/styles/themes/、src/styles/fonts/、output/
- [x] 1.2 删除 QA HTML 文件：qa-image.html、qa-image-actions.html、qa-image-remote-save.html、qa-mermaid-png.html

## 工具集成

- [x] 2.1 安装初始化 CodeGraph
- [x] 2.2 安装初始化 OpenSpec
- [x] 2.3 更新 .gitignore
