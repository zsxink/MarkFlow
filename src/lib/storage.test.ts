...
describe('storage IPC facade', () => {
  ...
  it('exposes image, export and recent-history commands', async () => {
    ...
    expect(invoke).toHaveBeenCalledWith('save_export', { kind: 'document', data: '<p>x</p>', fileName: 'x.html', extension: 'HTML', filterName: 'HTML', extensions: ['html'], hostContext: null });
