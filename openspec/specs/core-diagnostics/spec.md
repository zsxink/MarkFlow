...
Core-level diagnostics support for MarkFlow documents. Aggregates Core parse findings and identity-bound Host/UI diagnostic inputs into session-bound, viewport-filterable reports.
