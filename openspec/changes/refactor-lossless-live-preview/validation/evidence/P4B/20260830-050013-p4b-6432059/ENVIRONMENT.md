# P4B 7.2a semantic-E2E corrective immutable environment snapshot

| Field | Measured value |
| --- | --- |
| Recorded at | 2026-08-30T05:00:13+0800 |
...
| Predecessors | `20260830-043257-p4b-6432059` (rustfmt FAIL); `20260830-043642-p4b-6432059` (missing fixtures FAIL); `20260830-044524-p4b-6432059` (semantic E2E assertions FAIL) |
| Candidate corrections | rustfmt-only Core formatting; deterministic P4B reveal fixtures; preview-mode semantic hook; semantic fence construct count |
...
The candidate contains the 7.2a product/tests, three preserved failed evidence runs/issues, and the E2E harness corrections. The user-supplied untracked GOAL file is excluded. Exact `git status --short`:
