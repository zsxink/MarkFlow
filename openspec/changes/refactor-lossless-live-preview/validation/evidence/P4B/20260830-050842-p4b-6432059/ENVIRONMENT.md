# P4B 7.2a projection-observation corrective immutable environment snapshot

| Field | Measured value |
| --- | --- |
| Recorded at | 2026-08-30T05:08:42+0800 |
...
| Predecessors | `043257` rustfmt FAIL; `043642` missing fixtures FAIL; `044524` P4B semantic assertions FAIL; `050013` P2 projection observation race FAIL (full run ids in sibling evidence directories) |
| Candidate corrections | 7.2a product/contracts plus deterministic fixtures and rendered semantic-snapshot waits in desktop tests |
...
The candidate contains the 7.2a product/tests, four preserved failed evidence runs/issues, and E2E harness corrections. The user-supplied untracked GOAL file is excluded. Exact `git status --short`:
...
- Desktop runner uses an isolated generated workspace and removes it after success.
