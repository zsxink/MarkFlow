...
状态：FAIL (sealed; second native PDF readiness observation raced)

| Field | Value |
| --- | --- |
| Run ID | `20260830-054030-p4b-6432059` |
| Date/time | 2026-08-30T05:40:30+0800 |
| Operator | Codex main `/root` |
| Branch / start | `test/issue-255-lossless-byte-contract` / `6432059d29455ee8a4b7a4515ffff3aab371e2d0` |
| Environment | `./ENVIRONMENT.md` |
| Environment SHA-256 | `d6c27050e8e2615338708a9e005f07f0290543b303c2b3910c1e1b03e2259113` |
...
| C16 | desktop regression | FAIL (first PDF ready; second readiness timed out) | `gates/C16-e2e-regression.log` |
| C17 | desktop p0s | NOT RUN (blocked by C16) | no log |
| C18 | diff check | PASS | `gates/C18-diff-check.log` |

Every gate records command, UTC start/end, exit and raw output. Any failure seals this run. A fresh independent reviewer is required before commit.
