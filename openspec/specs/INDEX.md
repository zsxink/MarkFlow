...
- [file-tree-incremental-update](file-tree-incremental-update/spec.md) — 文件树增量更新。
...
- [multi-window-close-isolation](multi-window-close-isolation/spec.md) — 多窗口关闭隔离。
- [rendered-document-export](rendered-document-export/spec.md) — HTML、Word、PDF 导出。
- [write-file-permission](write-file-permission/spec.md) — 写文件权限与路径约束。

### 界面与渲染

- [context-menu](context-menu/spec.md) — 右键菜单 API 与交互。
- [dialog-system](dialog-system/spec.md) — 对话框结构、样式与创建方式。
- [docx-export](docx-export/spec.md) — DOCX 导出。
- [export-theme](export-theme/spec.md) — 导出主题。
- [font-stack](font-stack/spec.md) — 跨平台字体栈与分发。
- [html-export](html-export/spec.md) — HTML 导出。
- [lazy-mermaid](lazy-mermaid/spec.md) — Mermaid 按需加载与渲染状态。
- [pdf-export](pdf-export/spec.md) — PDF 导出。
- [plantuml-export](plantuml-export/spec.md) — PlantUML 导出。
...
- [toolbar-layout](toolbar-layout/spec.md) — 工具栏布局。
- [ui-aria-attributes](ui-aria-attributes/spec.md) — UI ARIA 属性。
