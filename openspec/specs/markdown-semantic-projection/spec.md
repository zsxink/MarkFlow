# markdown-semantic-projection Specification

## Purpose
定义 Markdown 语义投影的基础能力：生产级 concrete syntax 模型、版本化 Render IR v2、增量投影失效、optimistic/confirmed 投影对账，以及解析器一致性门禁。为 WYSIWYG 渲染、结构化编辑和编辑器输入完整性提供语义权威。
